...
type TInputProps<TFieldValues extends FieldValues = FieldValues> = {
  className?: string;
  disabled?: boolean;
  ...
  return (
    <div className={cn(`relative w-full`, className)}>
      ...
      <input
        ...
        className={`peer w-full rounded-lg border-2 bg-neutral-900 p-4 px-8 pt-6 text-base font-bold text-main-white outline-none transition-all duration-300 disabled:cursor-not-allowed disabled:opacity-70 ${formatPrice ? 'pl-9' : 'pl-4'} ${
          errors[id]
