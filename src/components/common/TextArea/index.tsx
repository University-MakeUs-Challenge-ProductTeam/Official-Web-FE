  ...
  return (
    <div className={cn(`relative w-full`, className)}>
      ...
      <textarea
        ...
        placeholder=" "
        className={`py-38 peer w-full resize-none rounded-lg border-2 bg-[#1B1B1B] p-4 px-32 pt-6 font-bold text-main-white outline-none transition-all duration-300 disabled:cursor-not-allowed disabled:opacity-70 ${formatPrice ? 'pl-9' : 'pl-4'} ${
          errors[id]
