...
function DescriptionBox({ description }: IDescriptionBoxProps) {
  return (
    <div className="flex w-full flex-col gap-6 rounded-[32px] border border-white/5 bg-white/5 p-8 backdrop-blur-3xl transition-all hover:border-[#52E560]/30 hover:bg-[#52E560]/5">
      <div className="space-y-2">
        <Typography className="text-xs font-bold uppercase tracking-widest text-[#52E560]">About</Typography>
